...
class Driver:
    ...
    def __str__(self):
        ...
        """
        # TODO
        return 'This is driver {} at {} going {} fast'.format(self.identifier, self.speed, self.location)
    ...
    def __eq__(self, other):
        ...
        """
        # TODO
        return self.identifier == other.identifier, self.speed == other.speed, self.location == other.location
    ...
    def start_ride(self, rider):
        ...
        return round(manhattan_distance(self.location, rider.origin)/self.speed)
